...
function BookPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Book a Meeting - Pixora</title>
        <meta name="description" content="Book a free consultation with Pixora - Google Meet, Zoom, or in-person in Karachi." />
        <meta property="og:title" content="Book a Meeting - Pixora" />
        <meta property="og:description" content="Tell us about your project. We'll set up a call." />
