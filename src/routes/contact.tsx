...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Pixora" },
      { name: "description", content: "Reach Pixora via WhatsApp, email, LinkedIn or Instagram, or send us a message." },
      { property: "og:title", content: "Contact — Pixora" },
